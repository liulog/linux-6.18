...
int cmd_script(int argc, const char **argv)
{
	...
	OPT_STRING('m', "machine-code", &symbol_conf.machine_code_name,
		   "file", "machine mode code binary pathname"),
	OPT_STRING(0, "machine-code-base", &symbol_conf.machine_code_base,
		   "address", "base address for machine mode code (e.g., 0x100000000)"),
